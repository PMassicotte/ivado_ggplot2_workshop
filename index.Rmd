...
Most people participating to the TidyTuesday challenges share their code on Github. It is a great way to learn more advanced techniques!
...
`r chunk_reveal(chunk_name = "axes_and_titles2", title = "# Controling scale labels")`
...
Faceting is a tool of the `ggplot2` library that allows displaying additional categorical variables in facets.
